...
namespace Client.Toolbox
{
    ...
    {
        /*public static readonly BindableProperty EventNameProperty = BindableProperty.Create("EventName", typeof(EventToCommandBehavior), typeof(Command), null);
        public static readonly BindableProperty CommandProperty = BindableProperty.Create("CommandProperty", typeof(EventToCommandBehavior), typeof(Command), null);
        public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create("CommandParameter", typeof(EventToCommandBehavior), typeof(Command), null);
        public static readonly BindableProperty EventArgsConverterProperty = BindableProperty.Create("EventArgsConverter", typeof(EventToCommandBehavior), typeof(Command), null);
        public static readonly BindableProperty EventArgsConverterParameterProperty = BindableProperty.Create("EventArgsConverterParameter", typeof(EventToCommandBehavior), typeof(Command), null);*/
